...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
    // Finding all the neighbors next to current_node
    current_node->FindNeighbors();
    // Iterating through all the found neighbors 
    for(int i = 0; i < current_node->neighbors.size(); i++){

        // Generating and adding all the needed information to the found and targeted neighbor
...
// - Return the pointer.
float compare (RouteModel::Node *node_1 , RouteModel::Node *node_2) {

    float value_1 = node_1->h_value + node_1->g_value;
    float value_2 = node_2->h_value + node_2->g_value;
